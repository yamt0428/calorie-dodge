  ...
  static List<AppBadge> getAllBadges() {
    return [
      ...
      AppBadge(
        ...
        threshold: 1000,
        description: '累計1,000kcalを達成しました！',
        icon: '🥉',
      ),
      AppBadge(
        id: 'calories_5000',
        ...
        type: BadgeType.calories,
        threshold: 5000,
        description: '累計5,000kcalを達成しました！',
        icon: '🥈',
      ),
      AppBadge(
        id: 'calories_10000',
        ...
        type: BadgeType.calories,
        threshold: 10000,
        description: '累計10,000kcalを達成しました！',
        icon: '🥇',
      ),
      AppBadge(
        id: 'calories_30000',
        ...
        type: BadgeType.calories,
        threshold: 30000,
        description: '累計30,000kcalを達成しました！',
        icon: '🏆',
      ),
      AppBadge(
        id: 'calories_50000',
        ...
        type: BadgeType.calories,
        threshold: 50000,
        description: '累計50,000kcalを達成しました！',
        icon: '👑',
      ),
